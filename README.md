...
1. [Download](https://github.com/DeclanFang/sharing-bay/archive/master.zip) the project or clone it to your computer by running `git clone https://github.com/DeclanFang/sharing-bay.git` on your Git terminal.
...
- v2.0.0 Add geocoder with Google's API to display location of posts in Google Map (check through branch [geocoder](https://github.com/DeclanFang/sharing-bay/tree/geocoder), not merge yet) - 2.7.2020

- v2.0.1 UI refactor of several pages - 2.7.2020
